...
class LlamaForCausalLM(nn.Module):
    def __init__(
        ...
        self.logits_agent = LogitsAgent(config)
    ...
    def forward(
        ...
        hidden_states = self.model(input_ids, positions, context, skip_embed)
        return self.logits_agent(input_ids, hidden_states, self.lm_head.weight, context)
